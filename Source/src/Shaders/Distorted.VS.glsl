...
// Perlin noise Functions - https://github.com/ashima/webgl-noise/blob/master/src/classicnoise3D.glsl
vec3 mod289(vec3 x)
{
...
void main()
{
	...
	float adjustedTime = time / 10;
	noise = 10.0 *  -.10 * turbulence( .5 * v_normal +  adjustedTime);
